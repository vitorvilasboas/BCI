...
if __name__ == "__main__":
    ...
    for suj in subjects:
        for class_ids in classes:  
            ...
            # data_cal, events_cal, _ = np.load('/mnt/dados/eeg_data/'+ ds +'/npy/A0' + str(suj) + 'T.npy', allow_pickle=True)
            # data_val, events_val, _ = np.load('/mnt/dados/eeg_data/'+ ds +'/npy/A0' + str(suj) + 'E.npy', allow_pickle=True)
            Fs = info['fs']
            filtering = 'DFT'
            ...
            pd.to_pickle(R, '/home/vboas/cloud/results/R_' + ds + '_' + str(suj) + '.pkl')
