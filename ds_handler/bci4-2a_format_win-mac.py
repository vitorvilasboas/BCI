...
def labeling(labels, ds, trues, suj): # normaliza rotulos de eventos conforme descrição oficial do dataset
...
if __name__ == '__main__': # load GDF and create NPY files
    folder = 'C:/Users/vboas/datasets/BCI4_2a/'
    dataset = ['T','E'] #
    classes = [1, 2, 3, 4]
    sujeitos = range(1,10)
    Fs = 250.0
    ...
    for ds in dataset:
        for suj in sujeitos:
            ...
            timestamps[:,1] = labeling(timestamps[:,1], ds, truelabels, suj)
